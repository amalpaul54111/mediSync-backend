...
async function mailing(email, category) {
  var mailOptions = {
    ...
    to: email,
    subject: "Registration on MediSync!!",
    // text: `You registered as a ${category} in farmcart enjoy the journey of trading your products.`,
    html: `You are now registerd as a/an ${category} in MediSync<br> 
    If you have any queries, feel free to contact us at queries@medisync.tk`,
  };
